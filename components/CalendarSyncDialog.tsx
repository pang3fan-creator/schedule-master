...
export function CalendarSyncDialog({
  ...
  const handleSync = async () => {
    ...
    try {
      ...
      const existingMappings: Record<string, string> = storedMappings
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="sm:max-w-md p-0 gap-0 overflow-hidden bg-white dark:bg-gray-900"
              ...
              {syncResult && (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    >
                      {syncResult.success
                        ? t("connected.syncComplete")
                        : t("connected.syncFailed")}
                    </span>
                  </div>
                  <p
                  ...
                  >
                    ...
                    {syncResult.failed > 0 &&
                      t("connected.eventsFailed", { count: syncResult.failed })}
                  </p>
                </div>
              )}
