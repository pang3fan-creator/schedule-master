...
function ImagePlaceholder({ size = "normal" }: { size?: "normal" | "large" }) {
    ...
    return (
        <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 text-blue-300">
...
export function BlogCard({
    ...
    if (featured) {
        return (
            <Link
                href={`/blog/${slug}`}
                className="group block rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden hover:shadow-md transition-shadow"
            >
