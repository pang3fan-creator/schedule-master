...
export function PricingCard({
  ...
  const renderButton = () => {
    ...
    if (isFree) {
      return (
        <>
          ...
          <p
            className="text-center text-xs text-transparent mt-1 select-none"
            aria-hidden="true"
          >
            &nbsp;
          </p>
    ...
    if (!purchaseCheck.allowed) {
      return (
        <>
          <Button variant="secondary" className="w-full mb-2" disabled>
  ...
  return (
    <div
      className={cn(
        ...
        popular
          ? "border-transparent bg-gradient-to-b from-gray-50 dark:from-gray-800/80 to-violet-50/30 dark:to-violet-900/20 ring-2 ring-blue-500/50"
