  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent
          className="sm:max-w-[520px] max-h-[85vh] p-0 gap-0 overflow-hidden flex flex-col bg-white dark:bg-gray-900"
                ...
                {isLimitReached && !usage?.isPro ? (
                  ...
                  <div className="py-6 text-center space-y-5">
                    ...
                    <div className="pt-2">
                      <Button
                        asChild
                        className="w-full max-w-[280px] bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 shadow-md text-white"
                      >
                        <Link
                          href="/pricing"
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2 text-green-600 dark:text-green-400 mb-4">
                  ...
                  <span className="font-medium">
                    {t("previewTitle", { count: generatedEvents.length })}
                  </span>
                </div>
                        ...
                        <div key={day}>
                          ...
                          <div className="space-y-2">
                            {events.map((event, idx) => {
                              ...
                              const globalIdx = generatedEvents.findIndex(
                                (e) => e === event,
                              );
