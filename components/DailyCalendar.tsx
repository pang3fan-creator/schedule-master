          ...
          <div className="md:hidden flex flex-col items-center">
            ...
            {!exportMode && (
              <div className="flex items-center justify-center w-full">
                ...
                <h2
                  className="text-base font-semibold text-gray-900 dark:text-gray-100 text-center flex-1 px-2 flex justify-center"
                  suppressHydrationWarning
                >
                  <Popover
            ...
            {hours.map((hour, index) => (
              <React.Fragment key={hour}>
                <div className="flex items-start justify-end pr-3">
                  <span className="text-xs font-medium text-gray-500 dark:text-gray-400 -translate-y-1/2 whitespace-nowrap">
                ...
                {index !== hours.length - 1 && (
                  <div
                    className="relative border-b border-l border-r border-gray-300 dark:border-gray-700"
                        ...
                        return (
                          ...
                          >
                            ...
                            {priorityModeEnabled && event.priority && (
                              <div
                                className={`absolute top-1 left-1 size-2.5 rounded-full ${PRIORITY_COLORS[event.priority].dot}`}
                            ...
                            <div className="flex items-center justify-center gap-1 overflow-hidden px-1">
                              ...
                              <p
                                className={`${getTitleClasses(displayMode, colorConfig.text)} ${event.task?.isCompleted ? "line-through opacity-60" : ""} truncate`}
                              >
                                {event.title}
                              </p>
                            </div>
                            ...
                            {shouldShowDescription(displayMode, false) &&
                              event.description && (
                                <p
