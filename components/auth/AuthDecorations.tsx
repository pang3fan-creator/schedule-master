...
export function DecorativeCircles() {
  return (
    <>
      ...
      <div
        className="absolute top-32 left-12 w-2 h-2 bg-white/20 rounded-full animate-pulse"
        style={{ animationDelay: "0.5s" }}
      />
      <div
        className="absolute bottom-24 right-16 w-2 h-2 bg-white/25 rounded-full animate-pulse"
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-gray-700 dark:text-gray-200">
            ...
            <span className="dark:text-gray-300">Schedule</span>
          </span>
        </div>
