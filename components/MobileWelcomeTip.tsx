            ...
            <div className="relative bg-white rounded-2xl shadow-xl max-w-sm w-full p-6 animate-in fade-in zoom-in duration-300">
                ...
                <div className="space-y-4">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">
                                Hold and drag event cards up or down to adjust the time.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <p className="font-medium text-gray-900">Double-tap to edit</p>
                            <p className="text-sm text-gray-500">
                                Double-tap an event card to open edit and delete options.
                            </p>
                        </div>
                    </div>
                </div>
