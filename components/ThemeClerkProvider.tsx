...
export function ThemeClerkProvider({
  children,
  locale,
}: ThemeClerkProviderProps) {
      ...
      appearance={{
        ...
        elements: {
          ...
          socialButtonsBlockButton:
            "text-gray-600 dark:text-gray-300 border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50",
          socialButtonsBlockButtonText: "text-gray-600 dark:text-gray-300",
          formFieldLabel: "text-gray-700 dark:text-gray-300",
          formFieldInput:
            "bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500",
          footerActionLink:
