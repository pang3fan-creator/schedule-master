    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                weekday:
                    "text-foreground w-10 font-medium text-[0.8rem] text-center",
                week: "flex w-full",
                week_number: "text-muted-foreground text-[0.8rem] w-8 flex items-center justify-center font-normal border-r border-border mr-2 py-2",
                week_number_header: "text-foreground text-[0.8rem] w-8 font-medium text-center border-r border-border mr-2 pb-4",
                day: cn(
