            ...
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                    <div className="bg-gray-50 dark:bg-gray-800/80 rounded-xl p-6 border border-slate-200 dark:border-gray-700 text-center">
                        ...
                        <h3 className="font-semibold text-gray-900 dark:text-white mb-2">{t('infoCards.email.title')}</h3>
                        <p className="text-gray-500 dark:text-gray-400 text-sm mb-2">{t('infoCards.email.description')}</p>
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800/80 rounded-xl p-6 border border-slate-200 dark:border-gray-700 text-center">
                        ...
                        <h3 className="font-semibold text-gray-900 dark:text-white mb-2">{t('infoCards.office.title')}</h3>
                        <p className="text-gray-500 dark:text-gray-400 text-sm">
                            {t('infoCards.office.address1')}<br />
                            {t('infoCards.office.address2')}<br />
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800/80 rounded-xl p-6 border border-slate-200 dark:border-gray-700 text-center">
                        ...
                        <h3 className="font-semibold text-gray-900 dark:text-white mb-2">{t('infoCards.hours.title')}</h3>
                        <p className="text-gray-500 dark:text-gray-400 text-sm">
                            {t('infoCards.hours.line1')}<br />
                            {t('infoCards.hours.line2')}<br />
                ...
                <div className="bg-gray-50 dark:bg-gray-800/80 rounded-xl p-8 border border-slate-200 dark:border-gray-700 shadow-sm">
                    {isSubmitted ? (
                        <div className="text-center py-12">
                            ...
                            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">{t('success.title')}</h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <Label htmlFor="name" className="text-gray-900 dark:text-white">{t('form.name.label')}</Label>
                                    <Input
                                        id="name"
                                        name="name"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="email" className="text-gray-900 dark:text-white">{t('form.email.label')}</Label>
                                    <Input
                                        id="email"
                                        name="email"
                                        type="email"
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="subject" className="text-gray-900 dark:text-white">{t('form.subject.label')}</Label>
                                <Input
                                    id="subject"
                                    name="subject"
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="message" className="text-gray-900 dark:text-white">{t('form.message.label')}</Label>
                                <textarea
                                    id="message"
                                    name="message"
