...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical:
        locale === "en" ? `${siteUrl}/pricing` : `${siteUrl}/${locale}/pricing`,
      languages: {
        en: `${siteUrl}/pricing`,
...
function generateProductSchemas(locale: string) {
  ...
  return [
    ...
    },
    {
      ...
      description:
        "Full pro features for one week - PDF export, AI scheduling, cloud sync",
    ...
    },
    {
      ...
      description:
        "Monthly subscription with all pro features including priority support",
