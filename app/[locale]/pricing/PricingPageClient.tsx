...
const PRODUCT_IDS = {
  ...
  monthly:
    process.env.NEXT_PUBLIC_CREEM_PRODUCT_MONTHLY || "prod_monthly_placeholder",
  lifetime:
    process.env.NEXT_PUBLIC_CREEM_PRODUCT_LIFETIME ||
    "prod_lifetime_placeholder",
};
...
export function PricingPageClient({ productSchemas }: PricingPageClientProps) {
  ...
  const comparisonTable = [
    {
      category: t("comparison.categories.coreTools"),
      feature: t("comparison.features.dragDrop"),
      free: true,
      pass: true,
      pro: true,
      lifetime: true,
    ...
    {
      category: t("comparison.categories.coreTools"),
      feature: t("comparison.features.visualBuilder"),
      free: true,
      pass: true,
      pro: true,
      lifetime: true,
    ...
    {
      category: t("comparison.categories.coreTools"),
      feature: t("comparison.features.mobileEditor"),
      free: true,
      pass: true,
      pro: true,
      lifetime: true,
    ...
    {
      category: t("comparison.categories.coreTools"),
      feature: t("comparison.features.downloadImage"),
      free: true,
      pass: true,
      pro: true,
      lifetime: true,
    ...
    {
      category: t("comparison.categories.exportSharing"),
    ...
    {
      category: t("comparison.categories.exportSharing"),
      feature: t("comparison.features.excelExport"),
      free: false,
      pass: true,
      pro: true,
      lifetime: true,
    ...
    {
      category: t("comparison.categories.exportSharing"),
      feature: t("comparison.features.googleSync"),
      free: false,
      pass: true,
      pro: true,
      lifetime: true,
    ...
    {
      category: t("comparison.categories.advancedPower"),
      feature: t("comparison.features.aiBuilder"),
      free: false,
      pass: true,
      pro: true,
      lifetime: true,
    ...
    {
      category: t("comparison.categories.advancedPower"),
      feature: t("comparison.features.unlimitedTemplates"),
      free: false,
      pass: true,
      pro: true,
      lifetime: true,
    ...
    {
      category: t("comparison.categories.advancedPower"),
      feature: t("comparison.features.cloudStorage"),
      free: false,
      pass: true,
      pro: true,
      lifetime: true,
    ...
    {
      category: t("comparison.categories.advancedPower"),
      feature: t("comparison.features.noWatermarks"),
      free: false,
      pass: true,
      pro: true,
      lifetime: true,
  ...
  const groupedTable = comparisonTable.reduce(
    (acc, row) => {
            ...
            <table className="w-full text-sm text-left">
              <thead className="bg-gray-50 dark:bg-gray-900/50 text-gray-900 dark:text-white font-medium">
                <tr>
                  ...
                  <th className="px-6 py-4 text-center w-1/6">
                    {t("comparison.headers.sevenDay")}
                  </th>
                  <th className="px-6 py-4 text-center w-1/6">
                    {t("comparison.headers.monthly")}
                  </th>
                  <th className="px-6 py-4 text-center w-1/6">
                    {t("comparison.headers.lifetime")}
                  </th>
                </tr>
              </thead>
                ...
                {Object.entries(groupedTable).map(([category, rows]) => (
                  <ReactFragment key={category}>
                    <tr className={`bg-gray-50/80 dark:bg-gray-900/30`}>
                      <td
                        colSpan={5}
                        className="px-6 py-4 font-semibold text-gray-900 dark:text-white text-sm tracking-wide uppercase"
                      >
                        {category}
                      </td>
                    </tr>
                    {rows.map((row) => (
                      <tr
                        key={row.feature}
                        className="hover:bg-violet-50/30 dark:hover:bg-gray-700/30 transition-colors duration-150"
                      >
