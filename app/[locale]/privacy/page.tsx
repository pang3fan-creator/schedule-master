...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical:
        locale === "en" ? `${siteUrl}/privacy` : `${siteUrl}/${locale}/privacy`,
      languages: {
        en: `${siteUrl}/privacy`,
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2 mb-4">
              {(
                t.raw(
                  "sections.informationCollect.personalInfo.items",
                ) as string[]
              ).map((item, index) => (
            ...
            <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2 mb-4">
              {(
                t.raw("sections.informationCollect.usageInfo.items") as string[]
              ).map((item, index) => (
                <li key={index}>{item}</li>
              ))}
            </ul>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2 mb-4">
              {(t.raw("sections.howWeUse.items") as string[]).map(
                (item, index) => (
                  <li key={index}>{item}</li>
                ),
              )}
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2 mb-4">
              {(t.raw("sections.informationSharing.items") as string[]).map(
                (item, index) => (
                  <li key={index}>{item}</li>
                ),
              )}
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2 mb-4">
              {(
                t.raw("sections.googleUserData.infoAccess.items") as string[]
              ).map((item, index) => (
                <li
                  key={index}
