...
export async function exportScheduleToPdf(
  ...
  try {
    ...
    if (viewMode === "week") {
      ...
      const d = dates[0];
      headerText = d.toLocaleDateString("en-US", {
        weekday: "long",
        month: "long",
        day: "numeric",
        year: "numeric",
    ...
    for (let col = 0; col < numCols; col++) {
      ...
      for (const event of dayEvents) {
        ...
        while (
          pdf.getTextWidth(displayTitle) > maxTextWidth &&
