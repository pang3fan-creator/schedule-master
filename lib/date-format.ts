 ...
 */
export function formatDate(dateString: string, locale: string = 'en', formatStr: string = 'PPP'): string {
    try {
 ...
 */
export function formatDateShort(dateString: string, locale: string = 'en'): string {
 ...
 */
export function formatDateNumeric(dateString: string, locale: string = 'en'): string {
