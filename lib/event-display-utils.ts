 ...
 */
export function getTimeClasses(
  mode: DisplayMode,
  colorTextSecondaryClass: string,
): string {
 ...
 */
export function getMobileWeeklyTitleClasses(
  mode: DisplayMode,
  colorTextClass: string,
): string {
 ...
 */
export function getMobileWeeklyTimeClasses(
  mode: DisplayMode,
  colorTextSecondaryClass: string,
): string {
 ...
 */
export function getMobileWeeklyDescriptionClasses(
  mode: DisplayMode,
  colorTextSecondaryClass: string,
): string {
