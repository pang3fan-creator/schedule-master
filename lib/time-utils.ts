...
export const DAY_NAMES_MONDAY_START = [
  "MON",
  "TUE",
  "WED",
  "THU",
...
export const DAY_NAMES_SUNDAY_START = [
  "SUN",
  "MON",
  "TUE",
  "WED",
...
export function calculateDraggedTime(
  ...
  let newStartTotalMinutes =
    originalStartHour * 60 + originalStartMinute + hourOffset * 60;
  const duration =
    originalEndHour * 60 +
    originalEndMinute -
    (originalStartHour * 60 + originalStartMinute);

  // Round to nearest timeIncrement for cleaner times
  newStartTotalMinutes =
    Math.round(newStartTotalMinutes / timeIncrement) * timeIncrement;
